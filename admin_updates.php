  ...
  <body style="background-color: lightyellow;">
    ...
    <form method="post">
	  ...
	  <ul class="nav nav-pills justify-content-center nav-fill">
				<li class="active"><a data-toggle="tab" href="#task">Display</a></li>
				<li><a data-toggle="tab" href="#progress">Assign</a></li>
			</ul>
        ...
        <div class="row">
			...
			<div class="tab-content bgcolor-white">
				<div id="task" class="tab-pane fade in active">
					...
					<h3>Information will be displayed below:</h3><hr>
				<!-- <table>
